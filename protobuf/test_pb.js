 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.main.Login.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getSeed();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {!proto.main.Login} The clone.
 */
proto.main.Login.prototype.cloneMessage = function() {
  return /** @type {!proto.main.Login} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {number}
 */
proto.main.Login.prototype.getSeed = function() {
  return /** @type {number} */ (jspb.Message.getFieldProto3(this, 1, 0));
};


/** @param {number} value  */
proto.main.Login.prototype.setSeed = function(value) {
